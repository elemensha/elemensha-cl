package com.elemensha.copy.update
...
import com.elemensha.copy.BuildConfig
import com.elemensha.copy.data.Api
import com.elemensha.copy.data.AppVersionInfo
...
class Updater(private val context: Context, private val api: Api) {
    ...
    suspend fun check(): State = runCatching {
        val info = api.latestVersion()   // 팔로워 앱은 copy 전용 APK 만 본다
        when {
    ...
    private fun fileName(info: AppVersionInfo) = "elemensha-copy-${info.versionName}.apk"
}
